...
void simulate(MyCase& myCase) {
  ...
  clout << "  VTM Output:      mixer_fluid.vtm, mixer_wholeReaction.vtm" << std::endl;
  clout << "========================================" << std::endl;
...
int main(int argc, char* argv[]) {
  ...
  MyCase::ParametersD myCaseParameters;
  {
    ...
    myCaseParameters.set<MAX_PHYS_TIME        >(0.0000001);
    myCaseParameters.set<MAX_PHYS_TIME_AD     >(0.0000001);
